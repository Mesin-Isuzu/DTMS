...
class App {
    ...
    _validateMapUrl(url) {
        ...
        if (!lower.startsWith('https://maps.google.com/?q=') && !lower.startsWith('https://www.google.com/maps/embed?')) {
            return { valid: false, msg: 'URL peta harus dalam format Google Maps ?q=, contoh:\nhttps://maps.google.com/?q=PT+Auto+Parts+Indonesia' };
        }
        return { valid: true };
    }

    _normalizeMapUrl(url) {
        if (!url || url.trim() === '') return '';
        url = url.trim();
        if (url.toLowerCase().startsWith('https://www.google.com/maps/embed?')) return url;
        try {
            const u = new URL(url);
    ...
    getToolingDetailView(id) {
        ...
        return `
            ...
            <div id="repair-history-section" class="card mt-4" style="scroll-margin-top: 1rem;">
                <div class="card-header">
                    <h3 class="card-title"><i class="fas fa-history" style="color: var(--accent-color); margin-right: 0.5rem;"></i> Riwayat Perbaikan</h3>
                        ...
                        if (logs.length === 0) {
                            return `
                                <div style="text-align: center; padding: 3rem 2rem; color: var(--text-secondary);">
                                    ...
                                    <p style="font-size: 1rem; font-weight: 500; margin-bottom: 0.25rem;">Belum Ada Riwayat Perbaikan</p>
            ...
            <div class="modal-content" style="max-width:520px;">
                ...
                <div class="modal-body" style="text-align:center;">
                    ...
                    <div style="background: #f8fafc; border-radius: 8px; padding: 0.75rem 1rem; text-align: left; font-size: 0.85rem; margin-bottom: 1rem;">
                        ...
                        ${maintCount > 0 ? `<div style="display:flex;justify-content:space-between;padding:0.2rem 0;"><span>Riwayat Perbaikan</span><span style="color:var(--danger-color);font-weight:600;">${maintCount} entri</span></div>` : ''}
